 ...
 * @author Hp
 */
public class InfoLibro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Panel.add(Libro1, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 50, -1, -1));

        Texto.setFont(new java.awt.Font("Burbank Big Rg Bk", 1, 18)); // NOI18N
        Texto.setForeground(new java.awt.Color(80, 112, 150));
        Texto.setText("<html> Título: The journal of Captain Rockhopper <br> Autor: Captain Rockhopper <br> ID: 0001 <br> ISBN: 1234 <br>Fecha de Publicacion: 10/08/2002 <br> Genero: Aventura <br> Nº Paginas: 144 <br> Idioma: Ingles <br> Ejemplares Disponibles: 2/2");
        Panel.add(Texto, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 340, 420, -1));
    ...
    private void EditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditarMouseClicked
        EditarLibro abrir = new EditarLibro();
